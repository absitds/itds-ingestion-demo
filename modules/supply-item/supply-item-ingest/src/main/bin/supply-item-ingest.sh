...
. ${MODULE_HOME}/etc/bin/supply-item-ingest.shell.properties
...
fn_check_batch_id_exist "${BATCH_ID_DATA_DIR}"/supply-item/"${BATCH_ID_FILE_NAME}"

fn_log_info "Importing table supply-item from teradata incrementally"

fn_get_value_from_file "${MIN_RECORD_DIR}/supply-item_min_record.value"

MIN_VAL="'${VAL}'"

fn_get_value_from_file "${MAX_RECORD_DIR}/supply-item_max_record.value"

MAX_VAL="'${VAL}'"

fn_get_value_from_file "${BATCH_ID_DATA_DIR}"/supply-item/"${BATCH_ID_FILE_NAME}"
